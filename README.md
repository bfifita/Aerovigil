...
Future versions of AeroVigil could support airline Safety Management Systems (SMS) and Fatigue Risk Management Systems (FRMS) by providing predictive analytics and operational risk visualization.
...
The fatigue scoring model used in this prototype is a simplified demonstration and should not be used for operational safety decisions.
```bash
git clone https://github.com/bosslady808/AeroVigil.git
cd AeroVigilpip install -r requirements.txtpip install -r requirements.txt          
